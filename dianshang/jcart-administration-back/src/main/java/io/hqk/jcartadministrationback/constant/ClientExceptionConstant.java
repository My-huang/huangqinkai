package io.hqk.jcartadministrationback.constant;
...
public class ClientExceptionConstant {
    ...
    public static final String ADNINISTRATOR_PASSWORD_INVALID_ERRCODE = "administrator password invalid exist";
    public static final String ADNINISTRATOR_PASSWORD_INVALID_ERRMSG = "administrator password invalid exist";
}
