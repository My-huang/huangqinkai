...
import io.hqk.jcartadministrationback.dao.ProductDetailMapper;
import io.hqk.jcartadministrationback.dao.ProductMapper;
...
import io.hqk.jcartadministrationback.po.ProductDetail;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Page<ProductListOutDTO> search(ProductSearchInDTO productSearchInDTO, Integer pageNum) {
        ...
        Page<ProductListOutDTO> page = productMapper.search(productSearchInDTO.getProductCode(),productSearchInDTO.getStatus(),productSearchInDTO.getStockQuantity(),productSearchInDTO.getPrice(),productSearchInDTO.getProductName());
        return page;
    }
